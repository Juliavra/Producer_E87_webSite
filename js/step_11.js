...
const fx_1_JCReverb = document.getElementById("fx_1_JCReverb");
const fx_1_JCReverb_value = document.getElementById("fx_1_JCReverb_value");

fx_1_JCReverb.addEventListener("change", function(e) {
  console.clear();
  console.log("e.currentTarget.value: " + e.currentTarget.value);
  fx_1_JCReverb_Node.roomSize = e.currentTarget.value;
...
//************************************************************************** */
//************************************************************************** */
//const fx_2_AutoFilter_Node = new Tone.AutoFilter(4);
/*
const fx_2_AutoFilter_Node = new Tone.AutoFilter(
  {
    frequency: 1,
    type: "sine",
    depth: 1,
...
const fx_2_autofilter_div = document.getElementById("fx_2_autofilter_div");
fx_2_autofilter_div.style.display = "none";

const fx_2_autofilter_baseFrequency = document.getElementById("fx_2_autofilter_baseFrequency");
const fx_2_autofilter_baseFrequency_value = document.getElementById("fx_2_autofilter_baseFrequency_value");
fx_2_autofilter_baseFrequency.addEventListener("change", function (e) {
  fx_2_AutoFilter_Node.baseFrequency = e.currentTarget.value;
  fx_2_autofilter_baseFrequency_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_2_autofilter_baseFrequency", e.currentTarget.value);
});

const fx_2_autofilter_depth = document.getElementById("fx_2_autofilter_depth");
const fx_2_autofilter_depth_value = document.getElementById("fx_2_autofilter_depth_value");
fx_2_autofilter_depth.addEventListener("change", function (e) {
  fx_2_AutoFilter_Node.depth.value = e.currentTarget.value;
  fx_2_autofilter_depth_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_2_autofilter_depth", e.currentTarget.value);
});

const fx_2_autofilter_frequency = document.getElementById("fx_2_autofilter_frequency");
const fx_2_autofilter_frequency_value = document.getElementById("fx_2_autofilter_frequency_value");
fx_2_autofilter_frequency.addEventListener("change", function (e) {
  fx_2_AutoFilter_Node.frequency.value = e.currentTarget.value;
  fx_2_autofilter_frequency_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_2_autofilter_frequency", e.currentTarget.value);
});

const fx_2_autofilter_octaves = document.getElementById("fx_2_autofilter_octaves");
const fx_2_autofilter_octaves_value = document.getElementById("fx_2_autofilter_octaves_value");
fx_2_autofilter_octaves.addEventListener("change", function (e) {
  fx_2_AutoFilter_Node.octaves = e.currentTarget.value;
  fx_2_autofilter_octaves_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_2_autofilter_octaves", e.currentTarget.value);
});

const fx_2_autofilter_select_type = document.getElementById("fx_2_autofilter_select_type");
fx_2_autofilter_select_type.addEventListener("change", function (e) {
  fx_2_AutoFilter_Node.type = e.currentTarget.value;
  mixEvent.logIntoListaAction(Tone.now(), "fx_2_autofilter_select_type", e.currentTarget.value);
});
...
//************************************************************************** */
/*
const fx_2_AutoPanner_Node = new Tone.AutoPanner({
  frequency: 1,
  type: "sine",
  depth: 1,
  wet: 1
});
const fx_2_autopanner_div = document.getElementById("fx_2_autopanner_div");
fx_2_autopanner_div.style.display = "none";

const fx_2_autoPanner_frequency = document.getElementById("fx_2_autoPanner_frequency");
const fx_2_autoPanner_frequency_value = document.getElementById("fx_2_autoPanner_frequency_value");
fx_2_autoPanner_frequency.addEventListener("change", function (e) {
  fx_2_AutoPanner_Node.frequency.value = e.currentTarget.value;
  fx_2_autoPanner_frequency_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_2_autoPanner_frequency", e.currentTarget.value);
});

const fx_2_autoPanner_depth = document.getElementById("fx_2_autoPanner_depth");
const fx_2_autoPanner_depth_value = document.getElementById("fx_2_autoPanner_depth_value");
fx_2_autoPanner_depth.addEventListener("change", function (e) {
  fx_2_AutoPanner_Node.depth.value = e.currentTarget.value;
  fx_2_autoPanner_depth_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_2_autoPanner_depth", e.currentTarget.value);
});

const fx_2_autoPanner_select_type = document.getElementById("fx_2_autoPanner_select_type");
const fx_2_autoPanner_select_type_value = document.getElementById("fx_2_autoPanner_select_type_value");
fx_2_autoPanner_select_type.addEventListener("change", function (e) {
  fx_2_AutoPanner_Node.type = e.currentTarget.value;
  mixEvent.logIntoListaAction(Tone.now(), "fx_2_autoPanner_select_type", e.currentTarget.value);
});
...
//************************************************************************** */
/*
const fx_2_AutoWah_Node = new Tone.AutoWah({
  wet: 1,
  baseFrequency: 100,
  octaves: 6,
  sensitivity: 0,
...
const fx_2_autowah_div = document.getElementById("fx_2_autowah_div");
fx_2_autowah_div.style.display = "none";

const fx_2_autoWah_octaves = document.getElementById("fx_2_autoWah_octaves");
const fx_2_autoWah_octaves_value = document.getElementById("fx_2_autoWah_octaves_value");
fx_2_autoWah_octaves.addEventListener("change", function (e) {
  fx_2_AutoWah_Node.octaves = e.currentTarget.value;
  fx_2_autoWah_octaves_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_2_autoWah_octaves", e.currentTarget.value);
});

const fx_2_autoWah_sensitivity = document.getElementById("fx_2_autoWah_sensitivity");
const fx_2_autoWah_sensitivity_value = document.getElementById("fx_2_autoWah_sensitivity_value");
fx_2_autoWah_sensitivity.addEventListener("change", function (e) {
  fx_2_AutoWah_Node.sensitivity = e.currentTarget.value;
  fx_2_autoWah_sensitivity_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_2_autoWah_sensitivity", e.currentTarget.value);
});

const fx_2_autoWah_Q = document.getElementById("fx_2_autoWah_Q");
const fx_2_autoWah_Q_value = document.getElementById("fx_2_autoWah_Q_value");
fx_2_autoWah_Q.addEventListener("change", function (e) {
  fx_2_AutoWah_Node.Q.value = e.currentTarget.value;
  fx_2_autoWah_Q_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_2_autoWah_Q", e.currentTarget.value);
});

const fx_2_autoWah_gain = document.getElementById("fx_2_autoWah_gain");
const fx_2_autoWah_gain_value = document.getElementById("fx_2_autoWah_gain_value");
fx_2_autoWah_gain.addEventListener("change", function (e) {
  fx_2_AutoWah_Node.gain.value = e.currentTarget.value;
  fx_2_autoWah_gain_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_2_autoWah_gain", e.currentTarget.value);
});

const fx_2_autoWah_follower_attack = document.getElementById("fx_2_autoWah_follower_attack");
const fx_2_autoWah_follower_attack_value = document.getElementById("fx_2_autoWah_follower_attack_value");
fx_2_autoWah_follower_attack.addEventListener("change", function (e) {
  fx_2_AutoWah_Node.follower.attack = e.currentTarget.value;
  fx_2_autoWah_follower_attack_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_2_autoWah_follower_attack", e.currentTarget.value);
});

const fx_2_autoWah_follower_release = document.getElementById("fx_2_autoWah_follower_release");
const fx_2_autoWah_follower_release_value = document.getElementById("fx_2_autoWah_follower_release_value");
fx_2_autoWah_follower_release.addEventListener("change", function (e) {
  fx_2_AutoWah_Node.follower.release.value = e.currentTarget.value;
  fx_2_autoWah_follower_release_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_2_autoWah_follower_release", e.currentTarget.value);
});

const fx_2_autoWah_baseFrequency = document.getElementById("fx_2_autoWah_baseFrequency");
const fx_2_autoWah_baseFrequency_value = document.getElementById("fx_2_autoWah_baseFrequency_value");
fx_2_autoWah_baseFrequency.addEventListener("change", function (e) {
  fx_2_AutoWah_Node.baseFrequency = e.currentTarget.value;
  fx_2_autoWah_baseFrequency_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_2_autoWah_baseFrequency", e.currentTarget.value);
});
...
//const fx_2_bitCrusher_Node = new Tone.BitCrusher();
//fx_2_bitCrusher_Node.wet = 1;
/*
const fx_2_bitCrusher_text = document.getElementById("fx_2_bitCrusher_text");
const fx_2_bitCrusher = document.getElementById("fx_2_bitCrusher");
const fx_2_bitCrusher_value = document.getElementById("fx_2_bitCrusher_value");

const fx_2_bitCrusher_div = document.getElementById("fx_2_bitCrusher_div");
fx_2_bitCrusher_div.style.display = "none";
/**/
//************************************************************************** */
//************************************************************************** */
//*********************** FX 1   CHEBYSHEV    ******************* */
...
//************************************************************************** */
/*
const fx_2_Chebyshev_Node = new Tone.Chebyshev({
  //order : 1 ,
  //oversample : "none",
  wet: 1
});
...
const fx_2_Chebyshev_div = document.getElementById("fx_2_Chebyshev_div");
fx_2_Chebyshev_div.style.display = "none";

const fx_2_Chebyshev_order = document.getElementById("fx_2_Chebyshev_order");
const fx_2_Chebyshev_order_value = document.getElementById("fx_2_Chebyshev_order_value");
fx_2_Chebyshev_order.addEventListener("change", function (e) {
  fx_2_Chebyshev_Node.order = Math.round(`${e.currentTarget.value}`);
  fx_2_Chebyshev_order_value.innerHTML = `${e.currentTarget.value}`;
});

const fx_2_Chebyshev_select_type = document.getElementById("fx_2_Chebyshev_select_type");
const fx_2_Chebyshev_select_type_value = document.getElementById("fx_2_Chebyshev_select_type_value");
fx_2_Chebyshev_select_type.addEventListener("change", function (e) {
  fx_2_Chebyshev_Node.type = e.currentTarget.value;
});
/**/
//************************************************************************** */
//************************************************************************** */
...
//************************************************************************** */
/*
const fx_2_chorus_Node = new Tone.Chorus({
  wet: 1
});

const fx_2_chorus_div = document.getElementById("fx_2_chorus_div");
fx_2_chorus_div.style.display = "none";

const fx_2_chorus_delayTime = document.getElementById("fx_2_chorus_delayTime");
const fx_2_chorus_delayTime_value = document.getElementById("fx_2_chorus_delayTime_value");
fx_2_chorus_delayTime.addEventListener("change", function (e) {
  fx_2_chorus_Node.delayTime = e.currentTarget.value;
  fx_2_chorus_delayTime_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_2_chorus_delayTime", e.currentTarget.value);
});

const fx_2_chorus_freq = document.getElementById("fx_2_chorus_freq");
const fx_2_chorus_freq_value = document.getElementById("fx_2_chorus_freq_value");
fx_2_chorus_freq.addEventListener("change", function (e) {
  fx_2_chorus_Node.frequency.value = e.currentTarget.value;
  fx_2_chorus_freq_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_2_chorus_freq", e.currentTarget.value);
});

const fx_2_chorus_depth = document.getElementById("fx_2_chorus_depth");
const fx_2_chorus_depth_value = document.getElementById("fx_2_chorus_depth_value");
fx_2_chorus_depth.addEventListener("change", function (e) {
  fx_2_chorus_Node.depth = e.currentTarget.value;
  fx_2_chorus_depth_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_2_chorus_depth", e.currentTarget.value);
});

const fx_2_chorus_spread = document.getElementById("fx_2_chorus_spread");
const fx_2_chorus_spread_value = document.getElementById("fx_2_chorus_spread_value");
fx_2_chorus_spread.addEventListener("change", function (e) {
  fx_2_chorus_Node.spread = e.currentTarget.value;
  fx_2_chorus_spread_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_2_chorus_spread", e.currentTarget.value);
});

const fx_2_chorus_feedback = document.getElementById("fx_2_chorus_feedback");
const fx_2_chorus_feedback_value = document.getElementById("fx_2_chorus_feedback_value");
fx_2_chorus_feedback.addEventListener("change", function (e) {
  fx_2_chorus_Node.feedback.value = e.currentTarget.value;
  fx_2_chorus_feedback_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_2_chorus_feedback", e.currentTarget.value);
});

const fx_2_chorus_select_type = document.getElementById("fx_2_chorus_select_type");
fx_2_chorus_select_type.addEventListener("change", function (e) {
  fx_2_chorus_Node.type = e.currentTarget.value;
  mixEvent.logIntoListaAction(Tone.now(), "fx_2_chorus_select_type", e.currentTarget.value);
});
/**/
//************************************************************************** */
//************************************************************************** */
...
//const fx_2_freeVerb_Node = new Tone.Freeverb();
//fx_2_freeVerb_Node.wet = 1;
/*
const fx_2_freeVerb_div = document.getElementById("fx_2_freeVerb_div");
fx_2_freeVerb_div.style.display = "none";

const fx_2_freeVerb_dampening = document.getElementById("fx_2_freeVerb_dampening");
const fx_2_freeVerb_dampening_value = document.getElementById("fx_2_freeVerb_dampening_value");
fx_2_freeVerb_dampening.addEventListener("change", function (e) {
  fx_2_freeVerb_Node.dampening = e.currentTarget.value;
  fx_2_freeVerb_dampening_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_2_freeVerb_dampening", e.currentTarget.value);
});

const fx_2_freeVerb_roomSize = document.getElementById("fx_2_freeVerb_roomSize");
const fx_2_freeVerb_roomSize_value = document.getElementById("fx_2_freeVerb_roomSize_value");
fx_2_freeVerb_roomSize.addEventListener("change", function (e) {
  fx_2_freeVerb_Node.roomSize.value = e.currentTarget.value;
  fx_2_freeVerb_roomSize_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_2_freeVerb_roomSize", e.currentTarget.value);
});
/**/
//*****************************************************************************************************
//*****************************************************************************************************
//******************************  FX 1   fx_2_FrequencyShifter     ****************************************
//*****************************************************************************************************
//*****************************************************************************************************
const fx_2_FrequencyShifter_Node = new Tone.FrequencyShifter({
  wet: 1
});
const fx_2_frequencyShifter_div = document.getElementById("fx_2_frequencyShifter_div");
fx_2_frequencyShifter_div.style.display = "none";

const fx_2_frequencyShifter = document.getElementById("fx_2_frequencyShifter");
const fx_2_frequencyShifter_value = document.getElementById("fx_2_frequencyShifter_value");
fx_2_frequencyShifter.addEventListener("change", function (e) {
  fx_2_FrequencyShifter_Node.frequency.value = e.currentTarget.value;
  fx_2_frequencyShifter_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_2_frequencyShifter", e.currentTarget.value);
});
...
//JC Reverb
/*
//const fx_2_JCReverb_Node = new Tone.JCReverb();
//fx_2_JCReverb_Node.wet = 1;

const fx_2_JCReverb = document.getElementById("fx_2_JCReverb");
const fx_2_JCReverb_value = document.getElementById("fx_2_JCReverb_value");

fx_2_JCReverb.addEventListener("change", function(e) {
  console.clear();
  console.log("e.currentTarget.value: " + e.currentTarget.value);
  fx_2_JCReverb_Node.roomSize = e.currentTarget.value;
  console.log("fx_2_JCReverb_Node: " + fx_2_JCReverb_Node.roomSize);
  fx_2_JCReverb_value.innerHTML = `${e.currentTarget.value}`;
});

/**/
const fx_2_JCReverb_div = document.getElementById("fx_2_JCReverb_div");
fx_2_JCReverb_div.style.display = "none";
...
//************************************************************************** */
/*
const fx_2_StereoWidener_Node = new Tone.StereoWidener({
  wet: 1
});
//The width control. 0 = 100% mid. 1 = 100% side. 0.5 = no change.
const fx_2_StereoWidener_div = document.getElementById("fx_2_StereoWidener_div");
fx_2_StereoWidener_div.style.display = "none";

const fx_2_StereoWidener_width = document.getElementById("fx_2_StereoWidener_width");
const fx_2_StereoWidener_width_value = document.getElementById("fx_2_StereoWidener_width_value");
fx_2_StereoWidener_width.addEventListener("change", function (e) {
  fx_2_StereoWidener_Node.width = e.currentTarget.value;
  fx_2_StereoWidener_width_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_2_StereoWidener_width", e.currentTarget.value);
});
/**/
//************************************************************************** */
//************************************************************************** */
...
//************************************************************************** */
//************************************************************************** */
const fx_2_tremolo_Node = new Tone.Tremolo({
  wet: 1
});
const fx_2_tremolo_div = document.getElementById("fx_2_tremolo_div");
fx_2_tremolo_div.style.display = "none";

const fx_2_tremolo_frequency = document.getElementById("fx_2_tremolo_frequency");
const fx_2_tremolo_frequency_value = document.getElementById("fx_2_tremolo_frequency_value");
fx_2_tremolo_frequency.addEventListener("change", function (e) {
  fx_2_tremolo_Node.frequency.value = e.currentTarget.value;
  fx_2_tremolo_frequency_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_2_tremolo_frequency", e.currentTarget.value);
});

const fx_2_tremolo_depth = document.getElementById("fx_2_tremolo_depth");
const fx_2_tremolo_depth_value = document.getElementById("fx_2_tremolo_depth_value");
fx_2_tremolo_depth.addEventListener("change", function (e) {
  fx_2_tremolo_Node.depth.value = e.currentTarget.value;
  fx_2_tremolo_depth_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_2_tremolo_depth", e.currentTarget.value);
});

const fx_2_tremolo_spread = document.getElementById("fx_2_tremolo_spread");
const fx_2_tremolo_spread_value = document.getElementById("fx_2_tremolo_spread_value");
fx_2_tremolo_spread.addEventListener("change", function (e) {
  fx_2_tremolo_Node.spread = e.currentTarget.value;
  fx_2_tremolo_spread_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_2_tremolo_spread", e.currentTarget.value);
});
...
const fx_2_vibrato_Node = new Tone.Vibrato({
  wet: 1
});
const fx_2_vibrato_div = document.getElementById("fx_2_vibrato_div");
fx_2_vibrato_div.style.display = "none";

const fx_2_vibrato_frequency = document.getElementById("fx_2_vibrato_frequency");
const fx_2_vibrato_frequency_value = document.getElementById("fx_2_vibrato_frequency_value");
fx_2_vibrato_frequency.addEventListener("change", function (e) {
  fx_2_vibrato_Node.frequency.value = e.currentTarget.value;
  fx_2_vibrato_frequency_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_2_vibrato_frequency", e.currentTarget.value);
});

const fx_2_vibrato_depth = document.getElementById("fx_2_vibrato_depth");
const fx_2_vibrato_depth_value = document.getElementById("fx_2_vibrato_depth_value");
fx_2_vibrato_depth.addEventListener("change", function (e) {
  fx_2_vibrato_Node.depth.value = e.currentTarget.value;
  fx_2_vibrato_depth_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_2_vibrato_depth", e.currentTarget.value);
});

const fx_2_vibrato_maxDelay = document.getElementById("fx_2_vibrato_maxDelay");
const fx_2_vibrato_maxDelay_value = document.getElementById("fx_2_vibrato_maxDelay_value");
fx_2_vibrato_maxDelay.addEventListener("change", function (e) {
  fx_2_vibrato_Node.maxDelay = e.currentTarget.value;
  fx_2_vibrato_maxDelay_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_2_vibrato_maxDelay", e.currentTarget.value);
});
...
//************************************************************************** */
/*
const fx_3_AutoFilter_Node = new Tone.AutoFilter(
  {
    frequency: 1,
    type: "sine",
    depth: 1,
...
const fx_3_autofilter_div = document.getElementById("fx_3_autofilter_div");
fx_3_autofilter_div.style.display = "none";

const fx_3_autofilter_baseFrequency = document.getElementById("fx_3_autofilter_baseFrequency");
const fx_3_autofilter_baseFrequency_value = document.getElementById("fx_3_autofilter_baseFrequency_value");
fx_3_autofilter_baseFrequency.addEventListener("change", function (e) {
  fx_3_AutoFilter_Node.baseFrequency = e.currentTarget.value;
  fx_3_autofilter_baseFrequency_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_3_autofilter_baseFrequency", e.currentTarget.value);
});

const fx_3_autofilter_depth = document.getElementById("fx_3_autofilter_depth");
const fx_3_autofilter_depth_value = document.getElementById("fx_3_autofilter_depth_value");
fx_3_autofilter_depth.addEventListener("change", function (e) {
  fx_3_AutoFilter_Node.depth.value = e.currentTarget.value;
  fx_3_autofilter_depth_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_3_autofilter_depth", e.currentTarget.value);
});

const fx_3_autofilter_frequency = document.getElementById("fx_3_autofilter_frequency");
const fx_3_autofilter_frequency_value = document.getElementById("fx_3_autofilter_frequency_value");
fx_3_autofilter_frequency.addEventListener("change", function (e) {
  fx_3_AutoFilter_Node.frequency.value = e.currentTarget.value;
  fx_3_autofilter_frequency_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_3_autofilter_frequency", e.currentTarget.value);
});

const fx_3_autofilter_octaves = document.getElementById("fx_3_autofilter_octaves");
const fx_3_autofilter_octaves_value = document.getElementById("fx_3_autofilter_octaves_value");
fx_3_autofilter_octaves.addEventListener("change", function (e) {
  fx_3_AutoFilter_Node.octaves = e.currentTarget.value;
  fx_3_autofilter_octaves_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_3_autofilter_octaves", e.currentTarget.value);
});

const fx_3_autofilter_select_type = document.getElementById("fx_3_autofilter_select_type");
fx_3_autofilter_select_type.addEventListener("change", function (e) {
  fx_3_AutoFilter_Node.type = e.currentTarget.value;
  mixEvent.logIntoListaAction(Tone.now(), "fx_3_autofilter_select_type", e.currentTarget.value);
});
...
//************************************************************************** */
/*
const fx_3_AutoPanner_Node = new Tone.AutoPanner({
  frequency: 1,
  type: "sine",
  depth: 1,
  wet: 1
});
const fx_3_autopanner_div = document.getElementById("fx_3_autopanner_div");
fx_3_autopanner_div.style.display = "none";

const fx_3_autoPanner_frequency = document.getElementById("fx_3_autoPanner_frequency");
const fx_3_autoPanner_frequency_value = document.getElementById("fx_3_autoPanner_frequency_value");
fx_3_autoPanner_frequency.addEventListener("change", function (e) {
  fx_3_AutoPanner_Node.frequency.value = e.currentTarget.value;
  fx_3_autoPanner_frequency_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_3_autoPanner_frequency", e.currentTarget.value);
});

const fx_3_autoPanner_depth = document.getElementById("fx_3_autoPanner_depth");
const fx_3_autoPanner_depth_value = document.getElementById("fx_3_autoPanner_depth_value");
fx_3_autoPanner_depth.addEventListener("change", function (e) {
  fx_3_AutoPanner_Node.depth.value = e.currentTarget.value;
  fx_3_autoPanner_depth_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_3_autoPanner_depth", e.currentTarget.value);
});

const fx_3_autoPanner_select_type = document.getElementById("fx_3_autoPanner_select_type");
const fx_3_autoPanner_select_type_value = document.getElementById("fx_3_autoPanner_select_type_value");
fx_3_autoPanner_select_type.addEventListener("change", function (e) {
  fx_3_AutoPanner_Node.type = e.currentTarget.value;
  mixEvent.logIntoListaAction(Tone.now(), "fx_3_autoPanner_select_type", e.currentTarget.value);
});
...
//************************************************************************** */
/*
const fx_3_AutoWah_Node = new Tone.AutoWah({
  wet: 1,
  baseFrequency: 100,
  octaves: 6,
  sensitivity: 0,
...
const fx_3_autowah_div = document.getElementById("fx_3_autowah_div");
fx_3_autowah_div.style.display = "none";

const fx_3_autoWah_octaves = document.getElementById("fx_3_autoWah_octaves");
const fx_3_autoWah_octaves_value = document.getElementById("fx_3_autoWah_octaves_value");
fx_3_autoWah_octaves.addEventListener("change", function (e) {
  fx_3_AutoWah_Node.octaves = e.currentTarget.value;
  fx_3_autoWah_octaves_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_3_autoWah_octaves", e.currentTarget.value);
});

const fx_3_autoWah_sensitivity = document.getElementById("fx_3_autoWah_sensitivity");
const fx_3_autoWah_sensitivity_value = document.getElementById("fx_3_autoWah_sensitivity_value");
fx_3_autoWah_sensitivity.addEventListener("change", function (e) {
  fx_3_AutoWah_Node.sensitivity = e.currentTarget.value;
  fx_3_autoWah_sensitivity_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_3_autoWah_sensitivity", e.currentTarget.value);
});

const fx_3_autoWah_Q = document.getElementById("fx_3_autoWah_Q");
const fx_3_autoWah_Q_value = document.getElementById("fx_3_autoWah_Q_value");
fx_3_autoWah_Q.addEventListener("change", function (e) {
  fx_3_AutoWah_Node.Q.value = e.currentTarget.value;
  fx_3_autoWah_Q_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_3_autoWah_Q", e.currentTarget.value);
});

const fx_3_autoWah_gain = document.getElementById("fx_3_autoWah_gain");
const fx_3_autoWah_gain_value = document.getElementById("fx_3_autoWah_gain_value");
fx_3_autoWah_gain.addEventListener("change", function (e) {
  fx_3_AutoWah_Node.gain.value = e.currentTarget.value;
  fx_3_autoWah_gain_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_3_autoWah_gain", e.currentTarget.value);
});

const fx_3_autoWah_follower_attack = document.getElementById("fx_3_autoWah_follower_attack");
const fx_3_autoWah_follower_attack_value = document.getElementById("fx_3_autoWah_follower_attack_value");
fx_3_autoWah_follower_attack.addEventListener("change", function (e) {
  fx_3_AutoWah_Node.follower.attack = e.currentTarget.value;
  fx_3_autoWah_follower_attack_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_3_autoWah_follower_attack", e.currentTarget.value);
});

const fx_3_autoWah_follower_release = document.getElementById("fx_3_autoWah_follower_release");
const fx_3_autoWah_follower_release_value = document.getElementById("fx_3_autoWah_follower_release_value");
fx_3_autoWah_follower_release.addEventListener("change", function (e) {
  fx_3_AutoWah_Node.follower.release.value = e.currentTarget.value;
  fx_3_autoWah_follower_release_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_3_autoWah_follower_release", e.currentTarget.value);
});

const fx_3_autoWah_baseFrequency = document.getElementById("fx_3_autoWah_baseFrequency");
const fx_3_autoWah_baseFrequency_value = document.getElementById("fx_3_autoWah_baseFrequency_value");
fx_3_autoWah_baseFrequency.addEventListener("change", function (e) {
  fx_3_AutoWah_Node.baseFrequency = e.currentTarget.value;
  fx_3_autoWah_baseFrequency_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_3_autoWah_baseFrequency", e.currentTarget.value);
});
...
//const fx_3_bitCrusher_Node = new Tone.BitCrusher();
//fx_3_bitCrusher_Node.wet = 1;
/*
const fx_3_bitCrusher_text = document.getElementById("fx_3_bitCrusher_text");
const fx_3_bitCrusher = document.getElementById("fx_3_bitCrusher");
const fx_3_bitCrusher_value = document.getElementById("fx_3_bitCrusher_value");

const fx_3_bitCrusher_div = document.getElementById("fx_3_bitCrusher_div");
fx_3_bitCrusher_div.style.display = "none";
...
//************************************************************************** */
/*
const fx_3_Chebyshev_Node = new Tone.Chebyshev({
  //order : 1 ,
  //oversample : "none",
  wet: 1
});

const fx_3_Chebyshev_div = document.getElementById("fx_3_Chebyshev_div");
fx_3_Chebyshev_div.style.display = "none";

const fx_3_Chebyshev_order = document.getElementById("fx_3_Chebyshev_order");
const fx_3_Chebyshev_order_value = document.getElementById("fx_3_Chebyshev_order_value");
fx_3_Chebyshev_order.addEventListener("change", function (e) {
  fx_3_Chebyshev_Node.order = Math.round(`${e.currentTarget.value}`);
  fx_3_Chebyshev_order_value.innerHTML = `${e.currentTarget.value}`;
});

const fx_3_Chebyshev_select_type = document.getElementById("fx_3_Chebyshev_select_type");
const fx_3_Chebyshev_select_type_value = document.getElementById("fx_3_Chebyshev_select_type_value");
fx_3_Chebyshev_select_type.addEventListener("change", function (e) {
  fx_3_Chebyshev_Node.type = e.currentTarget.value;
});
...
//************************************************************************** */
/*
const fx_3_distortion_Node = new Tone.Distortion({
  wet: 1
});

const fx_3_distortion_div = document.getElementById("fx_3_distortion_div");
fx_3_distortion_div.style.display = "none";

const fx_3_distortion = document.getElementById("fx_3_distortion");
const fx_3_distortion_value = document.getElementById("fx_3_distortion_value");
fx_3_distortion.addEventListener("change", function (e) {
  fx_3_distortion_Node.distortion = e.currentTarget.value;
  fx_3_distortion_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_3_distortion", e.currentTarget.value);
});

const fx_3_distortion_select_type = document.getElementById("fx_3_distortion_select_type");
fx_3_distortion_select_type.addEventListener("change", function (e) {
  fx_3_distortion_Node.type = e.currentTarget.value;
  mixEvent.logIntoListaAction(Tone.now(), "fx_3_distortion_select_type", e.currentTarget.value);
});
/**/
//************************************************************************** */
//************************************************************************** */
...
//const fx_3_freeVerb_Node = new Tone.Freeverb();
//fx_3_freeVerb_Node.wet = 1;
/*
const fx_3_freeVerb_div = document.getElementById("fx_3_freeVerb_div");
fx_3_freeVerb_div.style.display = "none";

const fx_3_freeVerb_dampening = document.getElementById("fx_3_freeVerb_dampening");
const fx_3_freeVerb_dampening_value = document.getElementById("fx_3_freeVerb_dampening_value");
fx_3_freeVerb_dampening.addEventListener("change", function (e) {
  fx_3_freeVerb_Node.dampening = e.currentTarget.value;
  fx_3_freeVerb_dampening_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_3_freeVerb_dampening", e.currentTarget.value);
});

const fx_3_freeVerb_roomSize = document.getElementById("fx_3_freeVerb_roomSize");
const fx_3_freeVerb_roomSize_value = document.getElementById("fx_3_freeVerb_roomSize_value");
fx_3_freeVerb_roomSize.addEventListener("change", function (e) {
  fx_3_freeVerb_Node.roomSize.value = e.currentTarget.value;
  fx_3_freeVerb_roomSize_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_3_freeVerb_roomSize", e.currentTarget.value);
});
/**/
//*****************************************************************************************************
//*****************************************************************************************************
//******************************  FX 1   fx_3_FrequencyShifter     ****************************************
//*****************************************************************************************************
//*****************************************************************************************************
...
//JC Reverb
/*
//const fx_3_JCReverb_Node = new Tone.JCReverb();
//fx_3_JCReverb_Node.wet = 1;

const fx_3_JCReverb = document.getElementById("fx_3_JCReverb");
const fx_3_JCReverb_value = document.getElementById("fx_3_JCReverb_value");

fx_3_JCReverb.addEventListener("change", function(e) {
  console.clear();
  console.log("e.currentTarget.value: " + e.currentTarget.value);
  fx_3_JCReverb_Node.roomSize = e.currentTarget.value;
  console.log("fx_3_JCReverb_Node: " + fx_3_JCReverb_Node.roomSize);
  fx_3_JCReverb_value.innerHTML = `${e.currentTarget.value}`;
});

const fx_3_JCReverb_div = document.getElementById("fx_3_JCReverb_div");
fx_3_JCReverb_div.style.display = "none";
/**/
//************************************************************************** */
//************************************************************************** */
//***********************  FX 1  PHASER    ******************* */
...
//************************************************************************** */
/*
const fx_3_phaser_Node = new Tone.Phaser({
  wet: 1
});
const fx_3_phaser_div = document.getElementById("fx_3_phaser_div");
fx_3_phaser_div.style.display = "none";

const fx_3_phaser_frequency = document.getElementById("fx_3_phaser_frequency");
const fx_3_phaser_frequency_value = document.getElementById("fx_3_phaser_frequency_value");
fx_3_phaser_frequency.addEventListener("change", function (e) {
  fx_3_phaser_Node.frequency.value = e.currentTarget.value;
  fx_3_phaser_frequency_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_3_phaser_frequency", e.currentTarget.value);
});

const fx_3_phaser_octaves = document.getElementById("fx_3_phaser_octaves");
const fx_3_phaser_octaves_value = document.getElementById("fx_3_phaser_octaves_value");
fx_3_phaser_octaves.addEventListener("change", function (e) {
  fx_3_phaser_Node.octaves = e.currentTarget.value;
  fx_3_phaser_octaves_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_3_phaser_octaves", e.currentTarget.value);
});

const fx_3_phaser_Q = document.getElementById("fx_3_phaser_Q");
const fx_3_phaser_Q_value = document.getElementById("fx_3_phaser_Q_value");
fx_3_phaser_Q.addEventListener("change", function (e) {
  fx_3_phaser_Node.Q.value = e.currentTarget.value;
  fx_3_phaser_Q_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_3_phaser_Q", e.currentTarget.value);
});

const fx_3_phaser_baseFrequency = document.getElementById("fx_3_phaser_baseFrequency");
const fx_3_phaser_baseFrequency_value = document.getElementById("fx_3_phaser_baseFrequency_value");
fx_3_phaser_baseFrequency.addEventListener("change", function (e) {
  fx_3_phaser_Node.baseFrequency = e.currentTarget.value;
  fx_3_phaser_baseFrequency_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_3_phaser_baseFrequency", e.currentTarget.value);
});
/**/
//************************************************************************** */
//************************************************************************** */
...
//************************************************************************** */
/*
const fx_3_StereoWidener_Node = new Tone.StereoWidener({
  wet: 1
});
//The width control. 0 = 100% mid. 1 = 100% side. 0.5 = no change.
const fx_3_StereoWidener_div = document.getElementById("fx_3_StereoWidener_div");
fx_3_StereoWidener_div.style.display = "none";

const fx_3_StereoWidener_width = document.getElementById("fx_3_StereoWidener_width");
const fx_3_StereoWidener_width_value = document.getElementById("fx_3_StereoWidener_width_value");
fx_3_StereoWidener_width.addEventListener("change", function (e) {
  fx_3_StereoWidener_Node.width = e.currentTarget.value;
  fx_3_StereoWidener_width_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_3_StereoWidener_width", e.currentTarget.value);
});
/**/
//************************************************************************** */
//************************************************************************** */
...
//************************************************************************** */
/*
const fx_3_tremolo_Node = new Tone.Tremolo({
  wet: 1
});
const fx_3_tremolo_div = document.getElementById("fx_3_tremolo_div");
fx_3_tremolo_div.style.display = "none";

const fx_3_tremolo_frequency = document.getElementById("fx_3_tremolo_frequency");
const fx_3_tremolo_frequency_value = document.getElementById("fx_3_tremolo_frequency_value");
fx_3_tremolo_frequency.addEventListener("change", function (e) {
  fx_3_tremolo_Node.frequency.value = e.currentTarget.value;
  fx_3_tremolo_frequency_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_3_tremolo_frequency", e.currentTarget.value);
});

const fx_3_tremolo_depth = document.getElementById("fx_3_tremolo_depth");
const fx_3_tremolo_depth_value = document.getElementById("fx_3_tremolo_depth_value");
fx_3_tremolo_depth.addEventListener("change", function (e) {
  fx_3_tremolo_Node.depth.value = e.currentTarget.value;
  fx_3_tremolo_depth_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_3_tremolo_depth", e.currentTarget.value);
});

const fx_3_tremolo_spread = document.getElementById("fx_3_tremolo_spread");
const fx_3_tremolo_spread_value = document.getElementById("fx_3_tremolo_spread_value");
fx_3_tremolo_spread.addEventListener("change", function (e) {
  fx_3_tremolo_Node.spread = e.currentTarget.value;
  fx_3_tremolo_spread_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_3_tremolo_spread", e.currentTarget.value);
});
/**/
//************************************************************************** */
//************************************************************************** */
...
//************************************************************************** */
/*
const fx_3_vibrato_Node = new Tone.Vibrato({
  wet: 1
});
const fx_3_vibrato_div = document.getElementById("fx_3_vibrato_div");
fx_3_vibrato_div.style.display = "none";

const fx_3_vibrato_frequency = document.getElementById("fx_3_vibrato_frequency");
const fx_3_vibrato_frequency_value = document.getElementById("fx_3_vibrato_frequency_value");
fx_3_vibrato_frequency.addEventListener("change", function (e) {
  fx_3_vibrato_Node.frequency.value = e.currentTarget.value;
  fx_3_vibrato_frequency_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_3_vibrato_frequency", e.currentTarget.value);
});

const fx_3_vibrato_depth = document.getElementById("fx_3_vibrato_depth");
const fx_3_vibrato_depth_value = document.getElementById("fx_3_vibrato_depth_value");
fx_3_vibrato_depth.addEventListener("change", function (e) {
  fx_3_vibrato_Node.depth.value = e.currentTarget.value;
  fx_3_vibrato_depth_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_3_vibrato_depth", e.currentTarget.value);
});

const fx_3_vibrato_maxDelay = document.getElementById("fx_3_vibrato_maxDelay");
const fx_3_vibrato_maxDelay_value = document.getElementById("fx_3_vibrato_maxDelay_value");
fx_3_vibrato_maxDelay.addEventListener("change", function (e) {
  fx_3_vibrato_Node.maxDelay = e.currentTarget.value;
  fx_3_vibrato_maxDelay_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_3_vibrato_maxDelay", e.currentTarget.value);
});
/**/
//************************************************************************** */
//************************************************************************** */
...
//************************************************************************** */
/*
const fx_4_AutoFilter_Node = new Tone.AutoFilter(
  {
    frequency: 1,
    type: "sine",
    depth: 1,
...
fx_4_autofilter_baseFrequency.addEventListener("change", function (e) {
  ...
  mixEvent.logIntoListaAction(Tone.now(), "fx_4_autofilter_baseFrequency", e.currentTarget.value);
});
...
fx_4_autofilter_depth.addEventListener("change", function (e) {
  ...
  mixEvent.logIntoListaAction(Tone.now(), "fx_4_autofilter_depth", e.currentTarget.value);
});
...
fx_4_autofilter_frequency.addEventListener("change", function (e) {
  ...
  mixEvent.logIntoListaAction(Tone.now(), "fx_4_autofilter_frequency", e.currentTarget.value);
});
...
fx_4_autofilter_octaves.addEventListener("change", function (e) {
  ...
  mixEvent.logIntoListaAction(Tone.now(), "fx_4_autofilter_octaves", e.currentTarget.value);
});
...
fx_4_autofilter_select_type.addEventListener("change", function (e) {
  ...
  mixEvent.logIntoListaAction(Tone.now(), "fx_4_autofilter_select_type", e.currentTarget.value);
});
...
//************************************************************************** */
/*
const fx_4_AutoPanner_Node = new Tone.AutoPanner({
  frequency: 1,
  type: "sine",
  depth: 1,
  wet: 1
...
fx_4_autoPanner_frequency.addEventListener("change", function (e) {
  ...
  mixEvent.logIntoListaAction(Tone.now(), "fx_4_autoPanner_frequency", e.currentTarget.value);
});
...
fx_4_autoPanner_depth.addEventListener("change", function (e) {
  ...
  mixEvent.logIntoListaAction(Tone.now(), "fx_4_autoPanner_depth", e.currentTarget.value);
});
...
fx_4_autoPanner_select_type.addEventListener("change", function (e) {
  ...
  mixEvent.logIntoListaAction(Tone.now(), "fx_4_autoPanner_select_type", e.currentTarget.value);
});
...
//************************************************************************** */
/*
const fx_4_AutoWah_Node = new Tone.AutoWah({
  wet: 1,
  baseFrequency: 100,
  octaves: 6,
  sensitivity: 0,
...
fx_4_autoWah_octaves.addEventListener("change", function (e) {
  ...
  mixEvent.logIntoListaAction(Tone.now(), "fx_4_autoWah_octaves", e.currentTarget.value);
});
...
fx_4_autoWah_sensitivity.addEventListener("change", function (e) {
  ...
  mixEvent.logIntoListaAction(Tone.now(), "fx_4_autoWah_sensitivity", e.currentTarget.value);
});
...
fx_4_autoWah_Q.addEventListener("change", function (e) {
  ...
  mixEvent.logIntoListaAction(Tone.now(), "fx_4_autoWah_Q", e.currentTarget.value);
});
...
fx_4_autoWah_gain.addEventListener("change", function (e) {
  ...
  mixEvent.logIntoListaAction(Tone.now(), "fx_4_autoWah_gain", e.currentTarget.value);
});
...
fx_4_autoWah_follower_attack.addEventListener("change", function (e) {
  ...
  mixEvent.logIntoListaAction(Tone.now(), "fx_4_autoWah_follower_attack", e.currentTarget.value);
});
...
fx_4_autoWah_follower_release.addEventListener("change", function (e) {
  fx_4_AutoWah_Node.follower.release.value = e.currentTarget.value;
  fx_4_autoWah_follower_release_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_4_autoWah_follower_release", e.currentTarget.value);
});
...
fx_4_autoWah_baseFrequency.addEventListener("change", function (e) {
  ...
  mixEvent.logIntoListaAction(Tone.now(), "fx_4_autoWah_baseFrequency", e.currentTarget.value);
});
/**/ 
//************************************************************************** */
//************************************************************************** */
...
//const fx_4_bitCrusher_Node = new Tone.BitCrusher();
//fx_4_bitCrusher_Node.wet = 1;
/*
...
/*const fx_4_Chebyshev_Node = new Tone.Chebyshev({
  //order : 1 ,
  //oversample : "none",
  wet: 1
});
...
//************************************************************************** */
/*
const fx_4_distortion_Node = new Tone.Distortion({
  wet: 1
});
...
fx_4_distortion.addEventListener("change", function (e) {
  ...
  mixEvent.logIntoListaAction(Tone.now(), "fx_4_distortion", e.currentTarget.value);
});
...
fx_4_distortion_select_type.addEventListener("change", function (e) {
  ...
  mixEvent.logIntoListaAction(Tone.now(), "fx_4_distortion_select_type", e.currentTarget.value);
});
/**/
//************************************************************************** */
//************************************************************************** */
...
//*****************************************************************************************************
/*
//const fx_4_freeVerb_Node = new Tone.Freeverb();
//fx_4_freeVerb_Node.wet = 1;

const fx_4_freeVerb_div = document.getElementById("fx_4_freeVerb_div");
...
fx_4_freeVerb_dampening.addEventListener("change", function (e) {
  ...
  mixEvent.logIntoListaAction(Tone.now(), "fx_4_freeVerb_dampening", e.currentTarget.value);
});
...
fx_4_freeVerb_roomSize.addEventListener("change", function (e) {
  ...
  mixEvent.logIntoListaAction(Tone.now(), "fx_4_freeVerb_roomSize", e.currentTarget.value);
});
/**/
//*****************************************************************************************************
//*****************************************************************************************************
//******************************  FX 4   fx_4_FrequencyShifter     ****************************************
//*****************************************************************************************************
//*****************************************************************************************************
...
//JC Reverb
/*
//const fx_4_JCReverb_Node = new Tone.JCReverb();
...
const fx_4_JCReverb_div = document.getElementById("fx_4_JCReverb_div");
...
//************************************************************************** */
/*
const fx_4_pitchshift_Node = new Tone.PitchShift({
  wet: 1
});
...
fx_4_pitchshift_feedback.addEventListener("change", function (e) {
  ...
  mixEvent.logIntoListaAction(Tone.now(), "fx_4_pitchshift_feedback", e.currentTarget.value);
});
...
fx_4_pitchshift_delayTime.addEventListener("change", function (e) {
  ...
  mixEvent.logIntoListaAction(Tone.now(), "fx_4_pitchshift_delayTime", e.currentTarget.value);
});
...
fx_4_pitchshift_pitch.addEventListener("change", function (e) {
  ...
  mixEvent.logIntoListaAction(Tone.now(), "fx_4_pitchshift_pitch", e.currentTarget.value);
});

const fx_4_pitchshift_windowSize = document.getElementById("fx_4_pitchshift_windowSize");
const fx_4_pitchshift_windowSize_value = document.getElementById("fx_4_pitchshift_windowSize_value");
fx_4_pitchshift_windowSize.addEventListener("change", function (e) {
  ...
  mixEvent.logIntoListaAction(Tone.now(), "fx_4_pitchshift_windowSize", e.currentTarget.value);
});
/**/
//************************************************************************** */
//************************************************************************** */
...
//************************************************************************** */
/*
const fx_4_StereoWidener_Node = new Tone.StereoWidener({
  wet: 1
});
//The width control. 0 = 100% mid. 1 = 100% side. 0.5 = no change.
...
fx_4_StereoWidener_width.addEventListener("change", function (e) {
  ...
  mixEvent.logIntoListaAction(Tone.now(), "fx_4_StereoWidener_width", e.currentTarget.value);
});
/**/
//************************************************************************** */
//************************************************************************** */
...
//************************************************************************** */
/*
const fx_4_tremolo_Node = new Tone.Tremolo({
  wet: 1
});
...
fx_4_tremolo_frequency.addEventListener("change", function (e) {
  fx_4_tremolo_Node.frequency.value = e.currentTarget.value;
  fx_4_tremolo_frequency_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_4_tremolo_frequency", e.currentTarget.value);
});
...
fx_4_tremolo_depth.addEventListener("change", function (e) {
  fx_4_tremolo_Node.depth.value = e.currentTarget.value;
  fx_4_tremolo_depth_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_4_tremolo_depth", e.currentTarget.value);
});
...
fx_4_tremolo_spread.addEventListener("change", function (e) {
  ...
  mixEvent.logIntoListaAction(Tone.now(), "fx_4_tremolo_spread", e.currentTarget.value);
});
/**/
//************************************************************************** */
//************************************************************************** */
...
//************************************************************************** */
/*
const fx_4_vibrato_Node = new Tone.Vibrato({
  wet: 1
});
...
fx_4_vibrato_frequency.addEventListener("change", function (e) {
  fx_4_vibrato_Node.frequency.value = e.currentTarget.value;
  fx_4_vibrato_frequency_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_4_vibrato_frequency", e.currentTarget.value);
});
...
fx_4_vibrato_depth.addEventListener("change", function (e) {
  fx_4_vibrato_Node.depth.value = e.currentTarget.value;
  fx_4_vibrato_depth_value.innerHTML = `${e.currentTarget.value}`;
  mixEvent.logIntoListaAction(Tone.now(), "fx_4_vibrato_depth", e.currentTarget.value);
});
...
fx_4_vibrato_maxDelay.addEventListener("change", function (e) {
  ...
  mixEvent.logIntoListaAction(Tone.now(), "fx_4_vibrato_maxDelay", e.currentTarget.value);
});
/**/
...
const channel_1_fxSend_2_preEq_volNode = new Tone.Volume(-100).connect(fx_2_pitchshift_Node);
const channel_1_fxSend_3_preEq_volNode = new Tone.Volume(-100).connect(fx_3_pitchshift_Node);
...
const channel_1_fxSend_2_postEq_volNode = new Tone.Volume(-100).connect(fx_2_pitchshift_Node);
const channel_1_fxSend_3_postEq_volNode = new Tone.Volume(-100).connect(fx_3_pitchshift_Node);
...
const channel_1_fxSend_2_postFdr_volNode = new Tone.Volume(-100).connect(fx_2_pitchshift_Node);
const channel_1_fxSend_3_postFdr_volNode = new Tone.Volume(-100).connect(fx_3_pitchshift_Node);
...
const player_2_fxSend_2_preEq_volNode = new Tone.Volume(-100).connect(fx_2_pitchshift_Node);
const player_2_fxSend_3_preEq_volNode = new Tone.Volume(-100).connect(fx_3_pitchshift_Node);
...
const player_2_fxSend_2_postEq_volNode = new Tone.Volume(-100).connect(fx_2_pitchshift_Node);
const player_2_fxSend_3_postEq_volNode = new Tone.Volume(-100).connect(fx_3_pitchshift_Node);
...
const player_2_fxSend_2_postFdr_volNode = new Tone.Volume(-100).connect(fx_2_pitchshift_Node);
const player_2_fxSend_3_postFdr_volNode = new Tone.Volume(-100).connect(fx_3_pitchshift_Node);
...
const player_3_fxSend_2_preEq_volNode = new Tone.Volume(-100).connect(fx_2_pitchshift_Node);
const player_3_fxSend_3_preEq_volNode = new Tone.Volume(-100).connect(fx_3_pitchshift_Node);
...
const player_3_fxSend_2_postEq_volNode = new Tone.Volume(-100).connect(fx_2_pitchshift_Node);
const player_3_fxSend_3_postEq_volNode = new Tone.Volume(-100).connect(fx_3_pitchshift_Node);
...
const player_3_fxSend_2_postFdr_volNode = new Tone.Volume(-100).connect(fx_2_pitchshift_Node);
const player_3_fxSend_3_postFdr_volNode = new Tone.Volume(-100).connect(fx_3_pitchshift_Node);
...
const player_4_fxSend_2_preEq_volNode = new Tone.Volume(-100).connect(fx_2_pitchshift_Node);
const player_4_fxSend_3_preEq_volNode = new Tone.Volume(-100).connect(fx_3_pitchshift_Node);
...
const player_4_fxSend_2_postEq_volNode = new Tone.Volume(-100).connect(fx_2_pitchshift_Node);
const player_4_fxSend_3_postEq_volNode = new Tone.Volume(-100).connect(fx_3_pitchshift_Node);
...
const player_4_fxSend_2_postFdr_volNode = new Tone.Volume(-100).connect(fx_2_pitchshift_Node);
const player_4_fxSend_3_postFdr_volNode = new Tone.Volume(-100).connect(fx_3_pitchshift_Node);
...
//********************************************************************************************
const fxReturn_1_fader = new Tone.Volume(-100).connect(fx_1_pan);
const fxReturn_2_fader = new Tone.Volume(-100).connect(fx_2_pan);
const fxReturn_3_fader = new Tone.Volume(-100).connect(fx_3_pan);
const fxReturn_4_fader = new Tone.Volume(-100).connect(fx_4_pan);
...
fx_1_pan_fader.addEventListener("change", function (e) {
  fx_1_pan.pan.value = e.currentTarget.value;
  fx_1_pan_value.innerHTML = Math.round(`${e.currentTarget.value}`);
...
fx2_volume.addEventListener("change", function (e) {
  if (e.currentTarget.value <= -40) {
    ...
    mixEvent.logIntoListaAction(Tone.now(), "fx2_volume", -100);
  }
  else {
    fxReturn_1_fader.volume.value = e.currentTarget.value;
    fx2_volume_value.innerHTML = Math.round(`${e.currentTarget.value}`);
    mixEvent.logIntoListaAction(Tone.now(), "fx2_volume", e.currentTarget.value);
  }
});

fx2_pan_fader.addEventListener("change", function (e) {
  fx2_pan.pan.value = e.currentTarget.value;
  fx2_pan_value.innerHTML = Math.round(`${e.currentTarget.value}`);
  mixEvent.logIntoListaAction(Tone.now(), "fx2_pan_fader", e.currentTarget.value);
});
//*********************************************************************************** */
//*********************************************************************************** */
//*************     INNERHTML           ********************************************* */
...
var fx_2_actual_patch = "fx_2_pitchshift";
var fx_3_actual_patch = "fx_3_pitchshift";
var fx_4_actual_patch = "fx_4_pitchshift";

var source_1_actual_patch = "empty";
var source_2_actual_patch = "empty";
var source_3_actual_patch = "empty";
var source_4_actual_patch = "empty";
...
fx_4_pitchshift_div.style.display = "block";
...
function send(value, player_1_volume_rampTo_gain, player_1_volume_rampTo_time) {
  ...
  if (player_1_volume_rampTo_gain.value != "" && player_1_volume_rampTo_time.value != "") {
    switch (value) {
      ...
      case "fx_2_tremolo_frequency": {
        fx_2_tremolo_Node.frequency.rampTo(`${player_1_volume_rampTo_gain.value}`, `${player_1_volume_rampTo_time.value}`);
        fx_2_tremolo_frequency_value.innerHTML = `${player_1_volume_rampTo_gain.value}`;
        fx_2_tremolo_frequency.value = `${player_1_volume_rampTo_gain.value}`;
        break;
      }
      case "fx_2_tremolo_depth": {
        fx_2_tremolo_Node.depth.rampTo(`${player_1_volume_rampTo_gain.value}`, `${player_1_volume_rampTo_time.value}`);
        fx_2_tremolo_depth_value.innerHTML = `${player_1_volume_rampTo_gain.value}`;
        fx_2_tremolo_depth.value = `${player_1_volume_rampTo_gain.value}`;
        break;
      }
      case "fx_2_tremolo_spread": {
        fx_2_tremolo_Node.spread.rampTo(`${player_1_volume_rampTo_gain.value}`, `${player_1_volume_rampTo_time.value}`);
        fx_2_tremolo_spread_value.innerHTML = `${player_1_volume_rampTo_gain.value}`;
        fx_2_tremolo_spread.value = `${player_1_volume_rampTo_gain.value}`;
        break;
      }
      case "fx_2_vibrato_frequency": {
        fx_2_vibrato_Node.frequency.rampTo(`${player_1_volume_rampTo_gain.value}`, `${player_1_volume_rampTo_time.value}`);
        fx_2_vibrato_frequency_value.innerHTML = `${player_1_volume_rampTo_gain.value}`;
        fx_2_vibrato_frequency.value = `${player_1_volume_rampTo_gain.value}`;
        break;
      }
      case "fx_2_vibrato_depth": {
        fx_2_vibrato_Node.depth.rampTo(`${player_1_volume_rampTo_gain.value}`, `${player_1_volume_rampTo_time.value}`);
        fx_2_vibrato_depth_value.innerHTML = `${player_1_volume_rampTo_gain.value}`;
        fx_2_vibrato_depth.value = `${player_1_volume_rampTo_gain.value}`;
        break;
      }
...
function removes_previous_effect(patch) {
  switch (patch) {
    ...
    case "fx_2_stereoWidener": {
      fx_2_StereoWidener_Node.disconnect(fxReturn_2_fader);
      fx_2_StereoWidener_div.style.display = "none";
      break;
    }
    case "fx_2_tremolo": {
      fx_2_tremolo_Node.disconnect(fxReturn_2_fader);
      fx_2_tremolo_div.style.display = "none";
      break;
    }
    case "fx_2_vibrato": {
      fx_2_vibrato_Node.disconnect(fxReturn_2_fader);
      fx_2_vibrato_div.style.display = "none";
      break;
    }
...
function sets_New_FX(channel, effecttype) {
  alerta("channel", channel);
  alerta("effecttype", effecttype);
...
*/
    ...
    case "FX2": {
      ...
      switch (effecttype) {
        case "AutoFilter"://FUNCIONA PERO NO TIENE SENTIDO
          {
            fx_2_AutoFilter_Node.connect(fxReturn_1_fader);
            channel_1_fxSend_1_preEq_volNode.connect(fx_2_AutoFilter_Node);
            channel_1_fxSend_1_postEq_volNode.connect(fx_2_AutoFilter_Node);
            channel_1_fxSend_1_postFdr_volNode.connect(fx_2_AutoFilter_Node);

            player_2_fxSend_1_preEq_volNode.connect(fx_2_AutoFilter_Node);
            player_2_fxSend_1_postEq_volNode.connect(fx_2_AutoFilter_Node);
            player_2_fxSend_1_postFdr_volNode.connect(fx_2_AutoFilter_Node);

            player_3_fxSend_1_preEq_volNode.connect(fx_2_AutoFilter_Node);
            player_3_fxSend_1_postEq_volNode.connect(fx_2_AutoFilter_Node);
            player_3_fxSend_1_postFdr_volNode.connect(fx_2_AutoFilter_Node);

            player_4_fxSend_1_preEq_volNode.connect(fx_2_AutoFilter_Node);
            player_4_fxSend_1_postEq_volNode.connect(fx_2_AutoFilter_Node);
            player_4_fxSend_1_postFdr_volNode.connect(fx_2_AutoFilter_Node);

            fx_2_autofilter_div.style.display = "block";
            fx_2_actual_patch = "fx_2_autofilter";
            break;
          }
        case "AutoPanner":  //NO FUNCA
          {
            fx_2_AutoPanner_Node.connect(fxReturn_1_fader);
            channel_1_fxSend_1_preEq_volNode.connect(fx_2_AutoPanner_Node);
            channel_1_fxSend_1_postEq_volNode.connect(fx_2_AutoPanner_Node);
            channel_1_fxSend_1_postFdr_volNode.connect(fx_2_AutoPanner_Node);

            player_2_fxSend_1_preEq_volNode.connect(fx_2_AutoPanner_Node);
            player_2_fxSend_1_postEq_volNode.connect(fx_2_AutoPanner_Node);
            player_2_fxSend_1_postFdr_volNode.connect(fx_2_AutoPanner_Node);

            player_3_fxSend_1_preEq_volNode.connect(fx_2_AutoPanner_Node);
            player_3_fxSend_1_postEq_volNode.connect(fx_2_AutoPanner_Node);
            player_3_fxSend_1_postFdr_volNode.connect(fx_2_AutoPanner_Node);

            player_4_fxSend_1_preEq_volNode.connect(fx_2_AutoPanner_Node);
            player_4_fxSend_1_postEq_volNode.connect(fx_2_AutoPanner_Node);
            player_4_fxSend_1_postFdr_volNode.connect(fx_2_AutoPanner_Node);

            fx_2_actual_patch = "fx_2_autopanner";
            fx_2_autopanner_div.style.display = "block";
            break;
          }
        case "AutoWah": //TEST
          {
            fx_2_AutoWah_Node.connect(fxReturn_1_fader);
            channel_1_fxSend_1_preEq_volNode.connect(fx_2_AutoWah_Node);
            channel_1_fxSend_1_postEq_volNode.connect(fx_2_AutoWah_Node);
            channel_1_fxSend_1_postFdr_volNode.connect(fx_2_AutoWah_Node);

            player_2_fxSend_1_preEq_volNode.connect(fx_2_AutoWah_Node);
            player_2_fxSend_1_postEq_volNode.connect(fx_2_AutoWah_Node);
            player_2_fxSend_1_postFdr_volNode.connect(fx_2_AutoWah_Node);

            player_3_fxSend_1_preEq_volNode.connect(fx_2_AutoWah_Node);
            player_3_fxSend_1_postEq_volNode.connect(fx_2_AutoWah_Node);
            player_3_fxSend_1_postFdr_volNode.connect(fx_2_AutoWah_Node);

            player_4_fxSend_1_preEq_volNode.connect(fx_2_AutoWah_Node);
            player_4_fxSend_1_postEq_volNode.connect(fx_2_AutoWah_Node);
            player_4_fxSend_1_postFdr_volNode.connect(fx_2_AutoWah_Node);

            fx_2_actual_patch = "fx_2_autowah";
            fx_2_autowah_div.style.display = "block";
            break;
          }
        case "BitCrusher":
          {
            /*
            fx_2_bitCrusher_Node.connect(fxReturn_1_fader);
            channel_1_fxSend_1_preEq_volNode.connect(fx_2_bitCrusher_Node);
            channel_1_fxSend_1_postEq_volNode.connect(fx_2_bitCrusher_Node);
            channel_1_fxSend_1_postFdr_volNode.connect(fx_2_bitCrusher_Node);

            player_2_fxSend_1_preEq_volNode.connect(fx_2_bitCrusher_Node);
            player_2_fxSend_1_postEq_volNode.connect(fx_2_bitCrusher_Node);
            player_2_fxSend_1_postFdr_volNode.connect(fx_2_bitCrusher_Node);

            player_3_fxSend_1_preEq_volNode.connect(fx_2_bitCrusher_Node);
            player_3_fxSend_1_postEq_volNode.connect(fx_2_bitCrusher_Node);
            player_3_fxSend_1_postFdr_volNode.connect(fx_2_bitCrusher_Node);

            player_4_fxSend_1_preEq_volNode.connect(fx_2_bitCrusher_Node);
            player_4_fxSend_1_postEq_volNode.connect(fx_2_bitCrusher_Node);
            player_4_fxSend_1_postFdr_volNode.connect(fx_2_bitCrusher_Node);
*/
            fx_2_actual_patch = "fx_2_bitCrusher";
            fx_2_bitCrusher_div.style.display = "block";
            break;
          }
        case "Chebyshev": //OK PERO PARECE UNA DISTORTION
          {
            fx_2_Chebyshev_Node.connect(fxReturn_1_fader);
            channel_1_fxSend_1_preEq_volNode.connect(fx_2_Chebyshev_Node);
            channel_1_fxSend_1_postEq_volNode.connect(fx_2_Chebyshev_Node);
            channel_1_fxSend_1_postFdr_volNode.connect(fx_2_Chebyshev_Node);

            player_2_fxSend_1_preEq_volNode.connect(fx_2_Chebyshev_Node);
            player_2_fxSend_1_postEq_volNode.connect(fx_2_Chebyshev_Node);
            player_2_fxSend_1_postFdr_volNode.connect(fx_2_Chebyshev_Node);

            player_3_fxSend_1_preEq_volNode.connect(fx_2_Chebyshev_Node);
            player_3_fxSend_1_postEq_volNode.connect(fx_2_Chebyshev_Node);
            player_3_fxSend_1_postFdr_volNode.connect(fx_2_Chebyshev_Node);

            player_4_fxSend_1_preEq_volNode.connect(fx_2_Chebyshev_Node);
            player_4_fxSend_1_postEq_volNode.connect(fx_2_Chebyshev_Node);
            player_4_fxSend_1_postFdr_volNode.connect(fx_2_Chebyshev_Node);

            fx_2_actual_patch = "fx_2_chebyshev";
            fx_2_Chebyshev_div.style.display = "block";
            break;
          }
        case "Chorus": //OK
          {
            fx_2_chorus_Node.connect(fxReturn_1_fader);

            channel_1_fxSend_1_preEq_volNode.connect(fx_2_chorus_Node);
            channel_1_fxSend_1_postEq_volNode.connect(fx_2_chorus_Node);
            channel_1_fxSend_1_postFdr_volNode.connect(fx_2_chorus_Node);

            player_2_fxSend_1_preEq_volNode.connect(fx_2_chorus_Node);
            player_2_fxSend_1_postEq_volNode.connect(fx_2_chorus_Node);
            player_2_fxSend_1_postFdr_volNode.connect(fx_2_chorus_Node);

            player_3_fxSend_1_preEq_volNode.connect(fx_2_chorus_Node);
            player_3_fxSend_1_postEq_volNode.connect(fx_2_chorus_Node);
            player_3_fxSend_1_postFdr_volNode.connect(fx_2_chorus_Node);

            player_4_fxSend_1_preEq_volNode.connect(fx_2_chorus_Node);
            player_4_fxSend_1_postEq_volNode.connect(fx_2_chorus_Node);
            player_4_fxSend_1_postFdr_volNode.connect(fx_2_chorus_Node);

            fx_2_actual_patch = "fx_2_chorus";
            fx_2_chorus_div.style.display = "block";
            break;
          }
        case "Distortion":  //OK
          {
            fx_2_distortion_Node.connect(fxReturn_1_fader);
            channel_1_fxSend_1_preEq_volNode.connect(fx_2_distortion_Node);
            channel_1_fxSend_1_postEq_volNode.connect(fx_2_distortion_Node);
            channel_1_fxSend_1_postFdr_volNode.connect(fx_2_distortion_Node);

            player_2_fxSend_1_preEq_volNode.connect(fx_2_distortion_Node);
            player_2_fxSend_1_postEq_volNode.connect(fx_2_distortion_Node);
            player_2_fxSend_1_postFdr_volNode.connect(fx_2_distortion_Node);

            player_3_fxSend_1_preEq_volNode.connect(fx_2_distortion_Node);
            player_3_fxSend_1_postEq_volNode.connect(fx_2_distortion_Node);
            player_3_fxSend_1_postFdr_volNode.connect(fx_2_distortion_Node);

            player_4_fxSend_1_preEq_volNode.connect(fx_2_distortion_Node);
            player_4_fxSend_1_postEq_volNode.connect(fx_2_distortion_Node);
            player_4_fxSend_1_postFdr_volNode.connect(fx_2_distortion_Node);
        ...
        case "FeedbackDelay": //OK
          {
            fx_2_feedback_Node.connect(fxReturn_1_fader);

            channel_1_fxSend_1_preEq_volNode.connect(fx_2_feedback_Node);
            channel_1_fxSend_1_postEq_volNode.connect(fx_2_feedback_Node);
            channel_1_fxSend_1_postFdr_volNode.connect(fx_2_feedback_Node);
            /*
                        player_2_fxSend_1_preEq_volNode.connect(fx_2_feedback_Node);
                        player_2_fxSend_1_postEq_volNode.connect(fx_2_feedback_Node);
                        player_2_fxSend_1_postFdr_volNode.connect(fx_2_feedback_Node);
            
                        player_3_fxSend_1_preEq_volNode.connect(fx_2_feedback_Node);
                        player_3_fxSend_1_postEq_volNode.connect(fx_2_feedback_Node);
                        player_3_fxSend_1_postFdr_volNode.connect(fx_2_feedback_Node);
            
                        player_4_fxSend_1_preEq_volNode.connect(fx_2_feedback_Node);
                        player_4_fxSend_1_postEq_volNode.connect(fx_2_feedback_Node);
                        player_4_fxSend_1_postFdr_volNode.connect(fx_2_feedback_Node);
            */
        ...
        case "Freeverb": // TIRA ERROR VIOLENTO
          {
            /*
            fx_2_freeVerb_Node.connect(fxReturn_1_fader);
            channel_1_fxSend_1_preEq_volNode.connect(fx_2_freeVerb_Node);
            channel_1_fxSend_1_postEq_volNode.connect(fx_2_freeVerb_Node);
            channel_1_fxSend_1_postFdr_volNode.connect(fx_2_freeVerb_Node);

            player_2_fxSend_1_preEq_volNode.connect(fx_2_freeVerb_Node);
            player_2_fxSend_1_postEq_volNode.connect(fx_2_freeVerb_Node);
            player_2_fxSend_1_postFdr_volNode.connect(fx_2_freeVerb_Node);

            player_3_fxSend_1_preEq_volNode.connect(fx_2_freeVerb_Node);
            player_3_fxSend_1_postEq_volNode.connect(fx_2_freeVerb_Node);
            player_3_fxSend_1_postFdr_volNode.connect(fx_2_freeVerb_Node);

            player_4_fxSend_1_preEq_volNode.connect(fx_2_freeVerb_Node);
            player_4_fxSend_1_postEq_volNode.connect(fx_2_freeVerb_Node);
            player_4_fxSend_1_postFdr_volNode.connect(fx_2_freeVerb_Node);
            
            fx_2_actual_patch = "fx_2_freeVerb";
            fx_2_freeVerb_div.style.display = "block";
            */
            break;
          }
        case "FrequencyShifter":  //OK
          {
            fx_2_FrequencyShifter_Node.connect(fxReturn_1_fader);

            channel_1_fxSend_1_preEq_volNode.connect(fx_2_FrequencyShifter_Node);
            channel_1_fxSend_1_postEq_volNode.connect(fx_2_FrequencyShifter_Node);
            channel_1_fxSend_1_postFdr_volNode.connect(fx_2_FrequencyShifter_Node);

            player_2_fxSend_1_preEq_volNode.connect(fx_2_FrequencyShifter_Node);
            player_2_fxSend_1_postEq_volNode.connect(fx_2_FrequencyShifter_Node);
            player_2_fxSend_1_postFdr_volNode.connect(fx_2_FrequencyShifter_Node);

            player_3_fxSend_1_preEq_volNode.connect(fx_2_FrequencyShifter_Node);
            player_3_fxSend_1_postEq_volNode.connect(fx_2_FrequencyShifter_Node);
            player_3_fxSend_1_postFdr_volNode.connect(fx_2_FrequencyShifter_Node);

            player_4_fxSend_1_preEq_volNode.connect(fx_2_FrequencyShifter_Node);
            player_4_fxSend_1_postEq_volNode.connect(fx_2_FrequencyShifter_Node);
            player_4_fxSend_1_postFdr_volNode.connect(fx_2_FrequencyShifter_Node);

            fx_2_actual_patch = "fx_2_frequencyShifter";
            fx_2_frequencyShifter_div.style.display = "block";
            break;
          }
        case "JCReverb":
          {
            /*
                        ...
                        newfx_2.connect(fxReturn_1_fader);
                        channel_1_fxSend_1_preEq_volNode.connect(newfx_2);
                        channel_1_fxSend_1_postEq_volNode.connect(newfx_2);
                        channel_1_fxSend_1_postFdr_volNode.connect(newfx_2);
            
                        player_2_fxSend_1_preEq_volNode.connect(newfx_2);
                        player_2_fxSend_1_postEq_volNode.connect(newfx_2);
                        player_2_fxSend_1_postFdr_volNode.connect(newfx_2);
            
                        player_3_fxSend_1_preEq_volNode.connect(newfx_2);
                        player_3_fxSend_1_postEq_volNode.connect(newfx_2);
                        player_3_fxSend_1_postFdr_volNode.connect(newfx_2);
            
                        player_4_fxSend_1_preEq_volNode.connect(newfx_2);
                        player_4_fxSend_1_postEq_volNode.connect(newfx_2);
                        player_4_fxSend_1_postFdr_volNode.connect(newfx_2);
            
                        /*
                            <div id="fx_2_JCReverb_div">
                              <br>
                              <fieldset>
                                <p id="fx_2_JCReverb_text">Frequency </p>
                                <input type='range' min=0 max=1 step='0.01' value="0" id='fx_2_JCReverb'>
                                <p id="fx_2_JCReverb_value"></p>
                                <br>
                              </fieldset>
                            </div>
            ...
            fx_2_JCReverb.addEventListener("change", function (e) {
              console.clear();
              console.log("e.currentTarget.value: " + e.currentTarget.value);
              fx_2_JCReverb_Node.roomSize.value = e.currentTarget.value;
              console.log("fx_2_JCReverb_Node: " + fx_2_JCReverb_Node.roomSize);
              fx_2_JCReverb_value.innerHTML = `${e.currentTarget.value}`;
            });
                        */
        ...
        case "Phaser":  //Testear NO ANDA NADA
          {
            fx_2_phaser_Node.connect(fxReturn_1_fader);
            channel_1_fxSend_1_preEq_volNode.connect(fx_2_phaser_Node);
            channel_1_fxSend_1_postEq_volNode.connect(fx_2_phaser_Node);
            channel_1_fxSend_1_postFdr_volNode.connect(fx_2_phaser_Node);

            player_2_fxSend_1_preEq_volNode.connect(fx_2_phaser_Node);
            player_2_fxSend_1_postEq_volNode.connect(fx_2_phaser_Node);
            player_2_fxSend_1_postFdr_volNode.connect(fx_2_phaser_Node);

            player_3_fxSend_1_preEq_volNode.connect(fx_2_phaser_Node);
            player_3_fxSend_1_postEq_volNode.connect(fx_2_phaser_Node);
            player_3_fxSend_1_postFdr_volNode.connect(fx_2_phaser_Node);

            player_4_fxSend_1_preEq_volNode.connect(fx_2_phaser_Node);
            player_4_fxSend_1_postEq_volNode.connect(fx_2_phaser_Node);
            player_4_fxSend_1_postFdr_volNode.connect(fx_2_phaser_Node);
        ...
        case "PingPongDelay": //OK
          {
            fx_2_pingpong_Node.connect(fxReturn_1_fader);

            channel_1_fxSend_1_preEq_volNode.connect(fx_2_pingpong_Node);
            channel_1_fxSend_1_postEq_volNode.connect(fx_2_pingpong_Node);
            channel_1_fxSend_1_postFdr_volNode.connect(fx_2_pingpong_Node);

            player_2_fxSend_1_preEq_volNode.connect(fx_2_pingpong_Node);
            player_2_fxSend_1_postEq_volNode.connect(fx_2_pingpong_Node);
            player_2_fxSend_1_postFdr_volNode.connect(fx_2_pingpong_Node);

            player_3_fxSend_1_preEq_volNode.connect(fx_2_pingpong_Node);
            player_3_fxSend_1_postEq_volNode.connect(fx_2_pingpong_Node);
            player_3_fxSend_1_postFdr_volNode.connect(fx_2_pingpong_Node);

            player_4_fxSend_1_preEq_volNode.connect(fx_2_pingpong_Node);
            player_4_fxSend_1_postEq_volNode.connect(fx_2_pingpong_Node);
            player_4_fxSend_1_postFdr_volNode.connect(fx_2_pingpong_Node);
            /**/
        ...
        case "PitchShift":  //OK
          {
            fx_2_pitchshift_Node.connect(fxReturn_1_fader);
            channel_1_fxSend_1_preEq_volNode.connect(fx_2_pitchshift_Node);
            channel_1_fxSend_1_postEq_volNode.connect(fx_2_pitchshift_Node);
            channel_1_fxSend_1_postFdr_volNode.connect(fx_2_pitchshift_Node);

            player_2_fxSend_1_preEq_volNode.connect(fx_2_pitchshift_Node);
            player_2_fxSend_1_postEq_volNode.connect(fx_2_pitchshift_Node);
            player_2_fxSend_1_postFdr_volNode.connect(fx_2_pitchshift_Node);

            player_3_fxSend_1_preEq_volNode.connect(fx_2_pitchshift_Node);
            player_3_fxSend_1_postEq_volNode.connect(fx_2_pitchshift_Node);
            player_3_fxSend_1_postFdr_volNode.connect(fx_2_pitchshift_Node);

            player_4_fxSend_1_preEq_volNode.connect(fx_2_pitchshift_Node);
            player_4_fxSend_1_postEq_volNode.connect(fx_2_pitchshift_Node);
            player_4_fxSend_1_postFdr_volNode.connect(fx_2_pitchshift_Node);
        ...
        case "Reverb": //REVISAR CUELGA TODO
          {
            fx_2_reverb_Node.connect(fxReturn_1_fader);

            channel_1_fxSend_1_preEq_volNode.connect(fx_2_reverb_Node);
            channel_1_fxSend_1_postEq_volNode.connect(fx_2_reverb_Node);
            channel_1_fxSend_1_postFdr_volNode.connect(fx_2_reverb_Node);

            player_2_fxSend_1_preEq_volNode.connect(fx_2_reverb_Node);
            player_2_fxSend_1_postEq_volNode.connect(fx_2_reverb_Node);
            player_2_fxSend_1_postFdr_volNode.connect(fx_2_reverb_Node);

            player_3_fxSend_1_preEq_volNode.connect(fx_2_reverb_Node);
            player_3_fxSend_1_postEq_volNode.connect(fx_2_reverb_Node);
            player_3_fxSend_1_postFdr_volNode.connect(fx_2_reverb_Node);

            player_4_fxSend_1_preEq_volNode.connect(fx_2_reverb_Node);
            player_4_fxSend_1_postEq_volNode.connect(fx_2_reverb_Node);
            player_4_fxSend_1_postFdr_volNode.connect(fx_2_reverb_Node);
        ...
        case "StereoWidener":
          {
            fx_2_StereoWidener_Node.connect(fxReturn_1_fader);
            channel_1_fxSend_1_preEq_volNode.connect(fx_2_StereoWidener_Node);
            channel_1_fxSend_1_postEq_volNode.connect(fx_2_StereoWidener_Node);
            channel_1_fxSend_1_postFdr_volNode.connect(fx_2_StereoWidener_Node);

            player_2_fxSend_1_preEq_volNode.connect(fx_2_StereoWidener_Node);
            player_2_fxSend_1_postEq_volNode.connect(fx_2_StereoWidener_Node);
            player_2_fxSend_1_postFdr_volNode.connect(fx_2_StereoWidener_Node);

            player_3_fxSend_1_preEq_volNode.connect(fx_2_StereoWidener_Node);
            player_3_fxSend_1_postEq_volNode.connect(fx_2_StereoWidener_Node);
            player_3_fxSend_1_postFdr_volNode.connect(fx_2_StereoWidener_Node);

            player_4_fxSend_1_preEq_volNode.connect(fx_2_StereoWidener_Node);
            player_4_fxSend_1_postEq_volNode.connect(fx_2_StereoWidener_Node);
            player_4_fxSend_1_postFdr_volNode.connect(fx_2_StereoWidener_Node);

            fx_2_actual_patch = "fx_2_stereoWidener";
            fx_2_StereoWidener_div.style.display = "block";
            break;
          }
        case "Tremolo": //TEST NO FUNCA
          {
            fx_2_tremolo_Node.connect(fxReturn_1_fader);
            channel_1_fxSend_1_preEq_volNode.connect(fx_2_tremolo_Node);
            channel_1_fxSend_1_postEq_volNode.connect(fx_2_tremolo_Node);
            channel_1_fxSend_1_postFdr_volNode.connect(fx_2_tremolo_Node);

            player_2_fxSend_1_preEq_volNode.connect(fx_2_tremolo_Node);
            player_2_fxSend_1_postEq_volNode.connect(fx_2_tremolo_Node);
            player_2_fxSend_1_postFdr_volNode.connect(fx_2_tremolo_Node);

            player_3_fxSend_1_preEq_volNode.connect(fx_2_tremolo_Node);
            player_3_fxSend_1_postEq_volNode.connect(fx_2_tremolo_Node);
            player_3_fxSend_1_postFdr_volNode.connect(fx_2_tremolo_Node);

            player_4_fxSend_1_preEq_volNode.connect(fx_2_tremolo_Node);
            player_4_fxSend_1_postEq_volNode.connect(fx_2_tremolo_Node);
            player_4_fxSend_1_postFdr_volNode.connect(fx_2_tremolo_Node);

            fx_2_actual_patch = "fx_2_tremolo";
            fx_2_tremolo_div.style.display = "block";
            break;
          }
        case "Vibrato": //Test NO FUNCA
          {
            fx_2_vibrato_Node.connect(fxReturn_1_fader);
            channel_1_fxSend_1_preEq_volNode.connect(fx_2_vibrato_Node);
            channel_1_fxSend_1_postEq_volNode.connect(fx_2_vibrato_Node);
            channel_1_fxSend_1_postFdr_volNode.connect(fx_2_vibrato_Node);

            player_2_fxSend_1_preEq_volNode.connect(fx_2_vibrato_Node);
            player_2_fxSend_1_postEq_volNode.connect(fx_2_vibrato_Node);
            player_2_fxSend_1_postFdr_volNode.connect(fx_2_vibrato_Node);

            player_3_fxSend_1_preEq_volNode.connect(fx_2_vibrato_Node);
            player_3_fxSend_1_postEq_volNode.connect(fx_2_vibrato_Node);
            player_3_fxSend_1_postFdr_volNode.connect(fx_2_vibrato_Node);

            player_4_fxSend_1_preEq_volNode.connect(fx_2_vibrato_Node);
            player_4_fxSend_1_postEq_volNode.connect(fx_2_vibrato_Node);
            player_4_fxSend_1_postFdr_volNode.connect(fx_2_vibrato_Node);

            fx_2_actual_patch = "fx_2_vibrato";
            fx_2_vibrato_div.style.display = "block";
            break;
          }
