...
/*
player_1_filter_gain_allpass.addEventListener("change", function (e) {
  player_1_filter.gain.value = e.currentTarget.value;
  console.log("player_1_filter.gain: " + e.currentTarget.value);
  player_1_filter_gain_allpass.innerHTML = Math.round(`${e.currentTarget.value}`);
});
*/
...
const player_1_limiter_reduction_text = document.getElementById("player_1_limiter_reduction_text");
...
player_1_limiter_threshold.addEventListener("change", function (e) {
  ...
  player_1_limiter_reduction_value.innerHTML = player_1_dynamics_limiterNode.reduction;
});
...
const player_1_LowShelf_FilterNode = new Tone.Filter();
...
const player_1_Mid_SemiParam_FilterNode = new Tone.Filter();
...
player_1_LowShelf_FilterNode.connect(player_1_Mid_SemiParam_FilterNode);
player_1_Mid_SemiParam_FilterNode.connect(player_1_HighShelf_FilterNode);
...
noise_1_fadeIn.addEventListener("change", function (e) {
  if (e.currentTarget.value >= 0 && e.currentTarget.value <= 1234) {
    ...
    alert("errororororor noise_1_Node.fadeIn_1");
  }
});
...
noise_1_fadeOut.addEventListener("change", function (e) {
  if (e.currentTarget.value >= 0 && e.currentTarget.value <= 1234) {
    ...
    alert("errororororor noise_1_Node.fadeOut");
  }
});
...
//---------------------------------------------------------------------
//GRAIN PLAYER
const grainPlayer_1_Node = new Tone.GrainPlayer().toDestination();
...
grainPlayer_1_loop_checkbox.addEventListener("change", function () {
  if (grainPlayer_1_loop_checkbox.checked) { grainPlayer_1_Node.loop = true; }
  else { grainPlayer_1_Node.loop = false; }
...
grainPlayer_1_reverse_checkbox.addEventListener("change", function () {
  if (grainPlayer_1_reverse_checkbox.checked) { grainPlayer_1_Node.reverse = true; }
  else { grainPlayer_1_Node.reverse = false; }
...
grainPlayer_1_autoplay_checkbox.addEventListener("change", function () {
  if (grainPlayer_1_autoplay_checkbox.checked) { grainPlayer_1_Node.autoplay = true; }
  else { grainPlayer_1_Node.autoplay = false; }
...
grainPlayer_1_loop_start.addEventListener("change", function (e) {
  if (e.currentTarget.value >= 0 && e.currentTarget.value <= 1234) {
    ...
    alert("errororororor grainPlayer_1_Node.loopStart");
  }
});
...
amOsc_1_Sync_checkbox.addEventListener("change", function () {
  if (amOsc_1_Sync_checkbox.checked) { amOsc_1.sync = true; }
  else { amOsc_1.sync = false; }
...
fmOsc_1_Sync_checkbox.addEventListener("change", function () {
  if (fmOsc_1_Sync_checkbox.checked) { fmOsc_1.sync = true; }
  else { fmOsc_1.sync = false; }
...
fmOsc_1_detune.addEventListener("change", function (e) {
  fmOsc_1.detune.value = e.currentTarget.value; console.log("fmOsc_1.detune: " + e.currentTarget.value);
...
fatOsc_1_Sync_checkbox.addEventListener("change", function () {
  if (fatOsc_1_Sync_checkbox.checked) { fatOsc_1.sync = true; }
  else { fatOsc_1.sync = false; }
...
omniOsc_1_Sync_checkbox.addEventListener("change", function () {
  if (omniOsc_1_Sync_checkbox.checked) { omniOsc_1.sync = true; }
  else { omniOsc_1.sync = false; }
...
oscillator_1_Sync_checkbox.addEventListener("change", function () {
  if (oscillator_1_Sync_checkbox.checked) { oscillator_1.sync = true; }
  else { oscillator_1.sync = false; }
...
pwmOsc_1_Sync_checkbox.addEventListener("change", function () {
  if (pwmOsc_1_Sync_checkbox.checked) { pwmOsc_1.sync = true; }
  else { pwmOsc_1.sync = false; }
...
pulseOsc_1_Sync_checkbox.addEventListener("change", function () {
  if (pulseOsc_1_Sync_checkbox.checked) { pulseOsc_1.sync = true; }
  else { pulseOsc_1.sync = false; }
...
amSynth_1.connect(masterVolume);
...
amSynth_1_Sync_checkbox.addEventListener("change", function () {
  if (amSynth_1_Sync_checkbox.checked) { amSynth_1.sync = true; }
  else { amSynth_1.sync = false; }
...
duoSynth_1_Sync_checkbox.addEventListener("change", function () {
  if (duoSynth_1_Sync_checkbox.checked) { duoSynth_1.sync = true; }
  else { duoSynth_1.sync = false; }
...
membraneSynth_1_Sync_checkbox.addEventListener("change", function () {
  if (membraneSynth_1_Sync_checkbox.checked) { membraneSynth_1.sync = true; }
  else { membraneSynth_1.sync = false; }
...
//************************************************************************** */
//************************************************************************** */
//***********************  connection  TEST METER VARIOUS PLAYER 1    ******************* */
//************************************************************************** */
//************************************************************************** */
...
player_1_HighShelf_FilterNode.fan(player_1_fxSend_1_postFdr_volNode, player_1_fxSend_2_postFdr_volNode, player_1_fxSend_3_postFdr_volNode, player_1_fxSend_4_postFdr_volNode);
...
player_1_filter_eq3.fan(player_1_fxSend_1_postFdr_volNode, player_1_fxSend_2_postFdr_volNode, player_1_fxSend_3_postFdr_volNode, player_1_fxSend_4_postFdr_volNode);
//************************************************************************** */
//************************************************************************** */
...
async function load_Local(value) {
  ...
  switch (value) {
    ...
    case "2":
      {
        player_2.buffer.set(decodedBuffer);
    ...
    case "2":
      {
        if (!player_2.loaded) {
          ...
          var duration = player_2.buffer.duration; console.log("else  player_2.buffer.duration:     " + player_2.buffer.duration);
  ...
  switch (source) {
    case "source_1": {
      switch (source_1_actual_patch) {
        ...
        case "noise": {
          noise_1_Node.disconnect(player_1_panNode);
          noise_1_div.style.display = "none";
          break;
        }
        case "pwmOscillator": {
        ...
        case "sampler": {
          sampler_1_Node.disconnect(player_1_panNode);
          sampler_1_div.style.display = "none";
          break;
        }
        case "grainPlayer": {
    ...
    case "source_1": {
      ...
      switch (value) {
        ...
        case "Noise": //
          {
            //alert("sets_New_Source: " + value);
            noise_1_Node.connect(player_1_panNode);
        ...
        case "Sampler":
          {
            //      alert("sets_New_Source: " + value);
            sampler_1_Node.connect(player_1_panNode);
        ...
        case "GrainPlayer": //
          {
            //       alert("sets_New_Source: " + value);
            grainPlayer_1_Node.connect(player_1_panNode);
...
player_2_rms_after_volume_value.innerHTML = Math.round(`${testMeter_2_after_volume.getValue()}`);
  testMeter_2_player_2_filter_Bypass_VALUE.innerHTML = Math.round(`${testMeter_2_player_2_filter_Bypass.getValue()}`);
  testMeter_2_player_2_filter_VALUE.innerHTML = Math.round(`${testMeter_2_player_2_filter.getValue()}`);
  testMeter_2_player_2_rms_comp_Bypass_value.innerHTML = Math.round(`${testMeter_2_player_2_rms_comp_Bypass.getValue()}`);
  testMeter_2_player_2_rms_comp_value.innerHTML = Math.round(`${testMeter_2_player_2_rms_comp.getValue()}`);
  testMeter_2_player_2_rms_gate_Bypass_value.innerHTML = Math.round(`${testMeter_2_player_2_rms_gate_Bypass.getValue()}`);
  testMeter_2_player_2_rms_gate_value.innerHTML = Math.round(`${testMeter_2_player_2_rms_gate.getValue()}`);
  testMeter_2_player_2_rms_limiter_Bypass_value.innerHTML = Math.round(`${testMeter_2_player_2_rms_limiter_Bypass.getValue()}`);
  //testMeter_2_player_2_rms_limiter_value.innerHTML = Math.round(`${testMeter_2_player_1_rms_limiter.getValue()}`);
...
const player_1_select_Available_Nodes = document.getElementById("player_1_select_Available_Nodes");
player_1_select_Available_Nodes.addEventListener("change", function (e) {
  //consoleClear();
