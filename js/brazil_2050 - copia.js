...
function acepta(){ 
  var ruta = document.getElementById("text_1");
  let ruta_trim = ruta.value.trim();
 // console.log("text_1_test: " + text_1_test);
  //console.log(" ruta_trim : " +  ruta_trim );
 // let ruta_exito= `${ruta_trim}` + `/01 Human Right  Ft. U Brown` + `.mp3`;
 let ruta_exito= `${ruta_trim}` + `/16 - Lick Samba` + `.mp3`;
  console.log(" ruta_exito: " +  ruta_exito );
