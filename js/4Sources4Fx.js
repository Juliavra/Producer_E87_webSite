function createsContext() {
  ...
  //const Player1 = new Tone.Player("https://juliavra.github.io/Producer_E87_webSite/audio/05 Deep Dark Amb Slow Loop.mp3");
...
function validateForm() {
  ...
  if (mensaje == "todoOk") {
    ...
    //let player_inner = `<input name = "player" value=${player_trim}>`;
    //var test_cadena = song_inner + " " + player_inner;
    //form.innerHTML = test_cadena;
    
    //document.body.append(form);
    //console.log("song: " + formulario.song);
    //form.submit();
    //alert(`${mensaje} + "Mensaje Enviado"`);
  }
  else { alert("abajo: " + mensaje); }
}//validateForm
