...
function createsContext() {
  ...
  //console.log(`array_Canciones: `+`array_Canciones[5].url_src`);
  //console.log(`array_Canciones: ` + array_Canciones[5].id);
  /*
    let i=0;
    for(i=0;i<100;i++)
    {
      console.log(`${array_Canciones[i].id}` + "     " + `${array_Canciones[i].url_src}`+ "   I = "+ i);
      console.log(`${array_Canciones[i].url_src}`);  
    }
  */

  /*
  for (i = 0; i < array_Canciones.length; i++) {
    console.log(`${array_Canciones[i].id}`);
  }
  /**/
...
function validateForm() {
  ...
  if (mensaje == "todoOk") {
    ...
    //alert("player_trim: " + player_trim);
    //alert("song_trim: " + song_trim);

   // let buffer = `${array_Canciones[i].id}`;
    //alert("buffer: " + buffer);
    //console.log(`${array_Canciones[i].id}` + "     " + `${array_Canciones[i].url_src}`+ "   I = "+ i);
